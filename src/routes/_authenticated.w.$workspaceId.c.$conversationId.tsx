...
function ConversationView() {
  ...
  // Reset live messages whenever conversation changes
  useEffect(() => {
    setLiveMessages([]);
  }, [conversationId]);
  ...
  const editor = useEditor({
    extensions: [StarterKit.configure({ heading: false, bulletList: false, orderedList: false, blockquote: false, horizontalRule: false })],
    content: "",
    editorProps: {
      attributes: {
        class:
