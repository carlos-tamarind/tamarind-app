      ...
      <Dialog open={open} onOpenChange={onOpenChange}>
        <DialogContent size="detail">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-1.5">
              <div className="text-xs font-semibold text-muted-foreground">Page ID</div>
              ...
              <div className="space-y-1.5">
                ...
                <ul className="max-h-40 overflow-y-auto rounded-md border bg-muted/30 p-2 text-sm">
                  {collaborators.length === 0 ? (
                    <li className="px-1 py-1 text-muted-foreground">No collaborators yet.</li>
                  ) : (
                    collaborators.map((c) => (
          ...
          {trashed && purgedAt ? (
            ...
            <>
              <DialogFooter className="flex-row items-center sm:flex-row sm:justify-start">
