  ...
  >
    {withHandle && (
      <div className="z-10 flex h-4 w-4 items-center justify-center rounded-sm border bg-background shadow-sm">
        <GripVertical className="hidden h-2.5 w-2.5 [[aria-orientation=vertical]_&]:block" />
        <GripHorizontal className="hidden h-2.5 w-2.5 [[aria-orientation=horizontal]_&]:block" />
      </div>
    )}
  </Separator>
);
